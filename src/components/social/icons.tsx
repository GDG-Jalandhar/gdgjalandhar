 ...
 * by nature). Hand-drawn here as stroke-only, 1.5px, currentColor line icons
 * matching the kit's own glyph weight — never vendor-colored brand marks, per
 * Design-Philosophy.md §8 ("Social icons").
 */
